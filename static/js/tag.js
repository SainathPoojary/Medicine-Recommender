...
let symp = ["itching", "skin_rash", "nodal_skin_eruptions", "continuous_sneezing", "shivering", "chills", "joint_pain", "stomach_pain", "acidity", "ulcers_on_tongue", "muscle_wasting", "vomiting", "burning_micturition", "spotting_urination",
    "fatigue",
    "weight_gain",
    "anxiety",
...
function addTag(e) {
    removeList();
    for (let i of sym) {
        if (i.toLowerCase().startsWith(input.value.toLowerCase()) && input.value != "" && !tags.includes(i)) {
